...
{
    // [Certo] Este arquivo não tinha nenhuma dependência de System.Windows (WPF) —
    // INotifyPropertyChanged/ObservableCollection são .NET puro e funcionam
    // idêntico com o binding do Avalonia. Copiado quase sem alteração.
    // DEPENDÊNCIA PENDENTE: os campos IsolatedPingWindow/StatusHistoryWindow
    // abaixo só compilam quando UI/IsolatedPingWindow e UI/StatusHistoryWindow
    // existirem como Window do Avalonia (Fase 4) com esses mesmos nomes.
